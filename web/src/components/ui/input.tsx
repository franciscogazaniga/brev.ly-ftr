  ...
  return (
    <div className="flex flex-col gap-y-2">
      <input
        id={inputId}
        ref={ref}
        className={`order-2 peer w-full p-4 focus:shadow-none border rounded-lg text-md-custom border-gray-300 text-gray-600 placeholder:text-gray-400 focus:outline-none focus:ring-[1.5px]
